...
async function onClosePosition() {
    ...
    jsonStatus['short_earnings_call']['carried_losses'] += 100.0 * info['open_pol'] * info['contracts']
    if (info['profit'] < 0) 
        jsonStatus['short_earnings_call']['carried_losses'] += info['profit']
    
    jsonStatus['short_earnings_call']['bs_premium'] += info['bs_premium']

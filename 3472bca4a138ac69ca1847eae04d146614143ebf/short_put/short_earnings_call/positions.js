...
async function loadPositionsData() {
    ...
    for (var key in table) {
        ...
        if  (position_info['assigned'] == true)
            continue
        if  (('option_type' in position_info) && (position_info['option_type'] != "short_earnings_call"))
            continue
        ...
        let jsonOptionTableInfo = findOptionInfo(jsonOptionInfo,'short_earnings_call',position_info['quote_symbol']);

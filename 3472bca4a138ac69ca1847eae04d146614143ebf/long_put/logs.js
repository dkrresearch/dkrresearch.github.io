...
async function loadLogData() {
    ...
    long_puts = []
    if (log_table.Item.info.hasOwnProperty('long_puts') == true)
        long_puts = log_table.Item.info.long_puts
    
    for (let s=0; s<long_puts.length; s++) {
        console.log(long_puts)
        symbolInfo = long_puts[s]

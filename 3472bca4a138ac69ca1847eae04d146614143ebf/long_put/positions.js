...
async function loadPositionsData() {
    ...
    for (var key in table) {
        ...
        if (('option_type' in position_info) == false)  //  legacy short_put
            continue
        if (position_info['option_type'] != "long_put")
            continue
        ...
        let jsonOptionTableInfo = findOptionInfo(jsonOptionInfo,'long_put',position_info['quote_symbol']);
...
function get_template() {
    ...
    <div class="positions_table_row">\
        <div class="positions_table_col_1">\
            <h1><a href="/long_put/position.html?symbol={$symbol_}&option_symbol={$option_symbol}&e={$e}">\
